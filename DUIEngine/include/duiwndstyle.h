...
protected:
    ...
    DUIWIN_DECLARE_ATTRIBUTES_BEGIN()
        ...
        DUIWIN_COLOR_ATTRIBUTE("crbghover", m_crBgHover, FALSE)
        DUIWIN_COLOR_ATTRIBUTE("crtext", m_crText, FALSE)
        DUIWIN_COLOR_ATTRIBUTE("crhover", m_crHoverText, FALSE)
		DUIWIN_COLOR_ATTRIBUTE("crpush", m_crPushText, FALSE)
        DUIWIN_COLOR_ATTRIBUTE("crdisabled", m_crDisabledText, FALSE)
